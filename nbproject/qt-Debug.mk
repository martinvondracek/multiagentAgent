...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?t máj 21 21:28:13 2015
...
OBJECTS       = build/Debug/GNU-Linux-x86/Agent.o \
		...
		build/Debug/GNU-Linux-x86/CoordinationPosition.o \
		build/Debug/GNU-Linux-x86/Obstacle.o \
		build/Debug/GNU-Linux-x86/Obstacles.o \
		build/Debug/GNU-Linux-x86/Position.o \
		build/Debug/GNU-Linux-x86/Positions.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/DP_agent1.0.0/ && $(COPY_FILE) --parents Agent.h AkcnyZasah.h CComport.h CiCreate.h CiCreateDef.h CoordinationPosition.h Obstacle.h Obstacles.h Position.h PositionsOfAgents.h SocketConnector.h SocketUtil.h agentForm.h build/Debug/GNU-Linux-x86/DP_agent1.0.0/ && $(COPY_FILE) --parents Agent.cpp AkcnyZasah.cpp CComport.cpp CiCreate.cpp CiCreateDef.cpp CoordinationPosition.cpp Obstacle.cpp Obstacles.cpp Position.cpp Positions.cpp SocketConnector.cpp SocketUtil.cpp agentForm.cpp main.cpp build/Debug/GNU-Linux-x86/DP_agent1.0.0/ && $(COPY_FILE) --parents agentForm.ui build/Debug/GNU-Linux-x86/DP_agent1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/DP_agent1.0.0` && $(TAR) DP_agent1.0.0.tar DP_agent1.0.0 && $(COMPRESS) DP_agent1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/DP_agent1.0.0`/DP_agent1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/DP_agent1.0.0
...
build/Debug/GNU-Linux-x86/Obstacles.o: Obstacles.cpp Obstacles.h \
		Obstacle.h \
		Position.h \
		CoordinationPosition.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/Obstacles.o Obstacles.cpp
...
build/Debug/GNU-Linux-x86/Positions.o: Positions.cpp PositionsOfAgents.h \
		Position.h \
		CoordinationPosition.h \
		Obstacle.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/Positions.o Positions.cpp
